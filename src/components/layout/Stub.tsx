  ...
  return (
    <main className="flex-1 grid place-items-center p-6">
      <div className="max-w-sm rounded-xl border border-border bg-card p-6 text-center shadow-sm">
        <div className="text-xs uppercase tracking-widest text-muted-foreground">Frollie POS</div>
        <h1 className="mt-2 text-2xl font-semibold">{name}</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          This screen is scaffolded — its implementation lands in a later wave.
        </p>
      </div>
    </main>
  );
